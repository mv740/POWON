...
-- -----------------------------------------------------
-- Table `powon`.`group_requests_member`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `powon`.`group_requests_member` (
  `group_id` INT NOT NULL,
  `sender_powon_id` INT NOT NULL,
  `reciever_powon_id` INT NOT NULL,
  PRIMARY KEY (`group_id`, `sender_powon_id`, `reciever_powon_id`),
  INDEX `fk_group_has_member1_member1_idx` (`sender_powon_id` ASC),
  INDEX `fk_group_has_member1_group1_idx` (`group_id` ASC),
  INDEX `dfdf_idx` (`reciever_powon_id` ASC),
  ...
  CONSTRAINT `fk_group_has_member1_member1`
    ...
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_group_has_member1_member2`
    FOREIGN KEY (`reciever_powon_id`)
    REFERENCES `powon`.`member` (`powon_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
