<div class="container">
    <ul class="nav nav-pills">
        <li role="presentation" class="active"><?php echo anchor('controller_email/viewReceivedEmail', "Inbox "
        ...
        <li style="margin-left :150px; font-size: 1.75em" role="presentation"><?php echo anchor('controller_email/viewReceivedEmail', '<span class="glyphicon glyphicon-refresh text-success" aria-hidden="true"></span>'); ?>
        </li>
    </ul>
    ...
    <div class="container" style="width: 800px">
        ...
        foreach($result as $row)
        {
            ...
            echo '<div class="panel panel-primary">
                    ...
                    .'<div class="row">
                            <div class="col-md-11">'
                                .'<span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> from :' . $row->sender_powon_id
                            .'</div>
                                <div class="col-md-1">'

                .form_open('controller_email/deleteInboxEmail/'.$id, $attributes)
