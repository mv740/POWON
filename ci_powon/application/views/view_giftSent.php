<div class="container">
    <ul class="nav nav-pills">
        ...
        <li role="presentation" class="active"><?php echo anchor('controller_gift/viewSentGift', '<span class="glyphicon glyphicon-gift " aria-hidden="true"></span> Send'
        ...
        <li style="margin-left :150px; font-size: 1.75em" role="presentation"><?php echo anchor('controller_gift/viewSentGift', '<span class="glyphicon glyphicon-refresh text-success" aria-hidden="true"></span>'); ?>
        </li>
    </ul>
    ...
    <div class="panel-heading">
        <h3 class="panel-title">'
                ...
                .'<div class="row">
                <div class="col-md-11">'
                .'<span class="text-danger"><span style="font-size: 1.75em" class="glyphicon glyphicon-gift" aria-hidden="true"></span></span> Sent to :' . $row->reciever_powon_id
                .'</div>
                <div class="col-md-1">'

                .form_open('controller_gift/deleteSentGift', $attributes)
